...
//The character class handels user input, and any data related to the player. Its main purpose is to turn
...
public class character {
  ...
  //Takes in a string from the user, and searches for certain keywords. It then turns those keywords into a command readable by other classes.
  //So "Use Crowbar on Door" turns into a playerInput object with "Use", "Crowbar", and "Door" as it's verb and objects. That then may be read by
